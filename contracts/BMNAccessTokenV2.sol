 ...
 *      Takes owner as constructor parameter to fix ownership issue
 */
contract BMNAccessTokenV2 is ERC20, Ownable {
    ...
    constructor(address _owner) ERC20("BMN Access Token V2", "BMN") Ownable(_owner) {
